  ...
  const repoCard = (
    <div className="animate-pulse rounded-lg border bg-card p-4">
      <div className="flex gap-2">
        <div className="flex flex-1 flex-col">
          <div className="flex items-center gap-1">
            <div className="h-4 w-1/3 bg-gray-600"></div>
          </div>
          <div className="mt-2 h-4 w-full bg-gray-600"></div>
        </div>
      ...
      <div className="mt-4 flex items-center gap-4">
        <div className="h-6 w-1/4 rounded bg-gray-600"></div>
        <div className="h-s w-1/4 rounded bg-gray-600"></div>
        <div className="h-6 w-1/4 rounded bg-gray-600"></div>
        <div className="h-6 w-1/4 rounded bg-gray-600"></div>
      </div>
    </div>
